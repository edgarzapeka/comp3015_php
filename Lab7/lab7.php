    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <a href="logout.php"><button class="btn btn-default" style="background-color: red;">Logout</button></a>
        </div>
...
<div class="modal-dialog" role="document">
    <form role="form" method="post" action="lab7.php" enctype="multipart/form-data">

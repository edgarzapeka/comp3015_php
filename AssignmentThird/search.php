    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <a href="users.php" class="btn btn-default">Users</a>
                <hr/>
            </div>
        </div>
                                                ...
                                                <tr class="'.$panelTag.'">
                                                    ...
                                                    <td>' . $filteredPost['searchResultsPostedTime'] . '</td> ';
                                                        ...
                                                        if (isset($_SESSION['admin']) && $_SESSION['admin'] == 1){
                                                           ...
                                                           echo "<td>
                                                            <a href='edit.php?id=$id'> <i class='fa fa-edit'> </i> edit</a>
                                                            <a href='delete.php?id=$id'> <i class='fa fa-remove'> </i> delete</a>
                                                            </td>";
                                                             }
